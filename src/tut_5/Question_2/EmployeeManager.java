...
/*Static fields are going to common to all the created objects of a perticular class. Hence it is not not going to be suitable for a filed like
address, because it can be different from company to company*/
